...
## Core Modules
- [x] [Auth & User Core](tracks/01-auth/index.md) - Identity, RBAC, and Session Management.
- [Project Management](tracks/02-projects/index.md) - Project lifecycle, Agile hierarchy, and CRUD.
- [Guild Module](tracks/03-guilds/index.md) - Guild structure, membership, and roles.
